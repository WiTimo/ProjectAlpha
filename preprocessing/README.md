...
The raw data is inside /data/raw/training or /data/raw/test and is a .csv file with no header that looks like this:
...
- If trade price ≥ best_ask at that time → aggressive buy
- If trade price ≤ best_bid at that time → aggressive sell
